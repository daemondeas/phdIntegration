 ...
 */
void Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Cchannelconnected(JNIEnv *env,
 ...
 * @param handle Communication handle
 */
void Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Cchanneldisconnected(JNIEnv *env, jobject obj,
								jint handle)
{
 ...
 */
void Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Cdatareceived(JNIEnv *env, jobject obj,
