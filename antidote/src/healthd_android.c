...
/*
 * Modified by Andreas Svantröm
 * \date Jan 26, 2016
 *
 * Modification: Changed package name of Java Export
 */
 ...
 */
void Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Ctimeralarm(JNIEnv *env, jobject obj, jint id)
{
	DEBUG("timer_alarm");
 ...
 */
void Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Creqmdsattr(JNIEnv *env, jobject obj, jint handle)
{
 ...
 * \param handle Context ID
 */
jstring Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Cgetconfig(JNIEnv *env, jobject obj, jint handle)
{
	DataList *list;
	char *xml_out;
 ...
 * \param handle Context ID
 */
void Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Creqmeasurement(JNIEnv *env, jobject obj, jint handle)
{
 ...
 */
void Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Creqactivationscanner(JNIEnv *env, jobject obj, jint handle, jint ihandle)
{
 ...
 * \param ihandle Object handle
 */
void Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Creqdeactivationscanner(JNIEnv *env, jobject obj, jint handle, jint ihandle)
{
 ...
 * \param handle Context ID
 */
void Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Creleaseassoc(JNIEnv *env, jobject obj, jint handle)
{
 ...
 * \param handle Context ID
 */
void Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Cabortassoc(JNIEnv *env, jobject obj, jint handle)
{
 ...
 * \param ihandle Object handle
 */
jint Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Cgetpmstore(JNIEnv *env,
 ...
 * \param ihandle Object handle
 */
jint Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Cgetsegminfo(JNIEnv *env, jobject obj, jint handle, jint ihandle)
{
	Request *req;
 ...
 * \param instnumber PM-Segment Instance number
 */
jint Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Cgetsegmdata(JNIEnv *env,
 ...
 * \param instnumber PM-Segment Instance number
 */
jint Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Cclearsegmdata(JNIEnv *env, jobject obj,
 ...
 * \param ihandle Object handle
 */
jint Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Cclearallsegmdata(JNIEnv *env, jobject obj,
 ...
 * @return int
 */
void Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Chealthdinit(JNIEnv *env, jobject obj, jstring tmp_path)
{
...
void Java_se_gladpingvin_develop_demohealthgateway_JNIBridge_Chealthdfinalize(JNIEnv *env, jobject obj)
{
	if (! bridge_obj)
		return;
